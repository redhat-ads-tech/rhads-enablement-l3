...
In the appearance customization lab, you worked in the OpenShift Project `brand-rhdh` and created a new {product_rhdh_name} instance. In this lab, you'll begin with a provided Developer Hub already running in a the `tssc-dh` Project. This instance is configured with the default lightweight TechDocs process. 

...
+
image::setup-rhdh/plugin-cache-pvc.png[link=self, window="image"]
...
+
image::setup-rhdh/plugin-cache-attached.png[link=self, window="image"]
...
+
image::setup-rhdh/plugin-cache-delete-pod.png[link=self, window="image"]
...
+
image::setup-rhdh/plugin-cache-install-skip.png[link=self, window="image"]

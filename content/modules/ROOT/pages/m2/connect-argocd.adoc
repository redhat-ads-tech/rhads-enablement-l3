...
To facilitate secure communication between {product_rhdh_name} and Argo CD, you should to create a dedicated readonly user account. It's possible to use the existing *admin* user account, however using principle of least privilege is best.

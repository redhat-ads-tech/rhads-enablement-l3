...
Recall that your environment has been pre-configured with a repository that contains a sample *catalog-info.yaml* in GitLab - https://gitlab-gitlab.{cluster_apps_domain}/development/argocd-example[module-2-assets/discovery-example].

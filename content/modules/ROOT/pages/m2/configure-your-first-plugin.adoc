...
. View the https://sso.apps.{openshift_cluster_ingress_domain}/admin/master/console/#/trusted-artifact-signer/clients[clients list in the `trusted-artifact-signer` realm] in Keycloak - login as *admin* using the password you copied from the Secret.
+ 
[NOTE]
====

...
//
//  Some reluctance to include above link to backstageio theme doc bc
...
//todone: check: intra-linking - is there a better notation? I'm just ~guessing the file ext .html and using any-ol external link notation

//todone: check: Removed sentence about icon logo (vs fullLogo).
...
Copy the complete ConfigMap declaration from  _<<Appendix A>>_ at the bottom of this page. The explanation of the keys above is abrigded for readability.

...
This module focuses on the first: Visual customizations. It demonstrates the fundamental method for customizing your {product_rhdh_name} instance by walking through title and logo changes as a practical example. 

[NOTE]
====
The same configuration techniques apply to all customization types, whether visual or functional. Visit the xref:setup-rhdh/foundations.adoc[Setup {product_rhdh_name}] module to understand how to configure functional aspects of a {product_rhdh_name} instance, like access control and plugin settings.
====

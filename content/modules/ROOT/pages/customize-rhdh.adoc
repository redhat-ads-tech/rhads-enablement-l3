...
* **Workflow customizations**: Create custom templates for services, components, and other resources to standardize and streamline developer workflows
* **Content customizations**: Configure TechDocs to provide centralized, searchable technical documentation for your teams
* **Functional customizations**: Set up access control, configure plugins, and adjust other functional settings to meet your operational requirements

This module demonstrates the fundamental method for customizing your {product_rhdh_name} instance by walking through title and logo changes as a practical example. The same configuration techniques apply to all customization types, whether visual, workflow, content, or functional.

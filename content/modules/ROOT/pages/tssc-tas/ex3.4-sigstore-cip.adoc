...
And here's https://signed-image-keyless-student-admission-test.{openshift_cluster_ingress_domain}[more proof^,window="deployedimage"] it made it onto our cluster. 😉

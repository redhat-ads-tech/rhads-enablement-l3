...
image::tssc-tas/acs-cluster-config.png[link=self, window="image"] 
...
image::tssc-tas/acs-cluster-config-detail.png[link=self, window="image"]
...
image::tssc-tas/acs-policies.png[link=self, window="image"]
...
image::tssc-tas/acs-policies-deploy.png[link=self, window="image"]
...
image::tssc-tas/acs-create-integration.png[link=self, window="image"]
...
image::tssc-tas/acs-create-integration-new-integration.png[link=self, window="image"]
...
image::tssc-tas/acs-create-signature-integration-keyless.png[link=self, window="image"]
...
image::tssc-tas/acs-create-signature-integration-tlog.png[link=self, window="image"]
...
image::tssc-tas/acs-create-signature-integration-filled.png[link=self, window="image"]
...
image::tssc-tas/acs-create-signature-integration-created.png[link=self, window="image"]
...
image::tssc-tas/acs-create-policy.png[link=self, window="image"]
...
image::tssc-tas/acs-create-policy-2.png[link=self, window="image"]

3) Select "Deploy" as the lifecycle stage (as that is relevant for admission control) and click "next"

image::tssc-tas/acs-create-policy-3.png[link=self, window="image"]
...
image::tssc-tas/acs-create-policy-4-dnd.png[link=self, window="image"]

Then, configure your first rule by selecting an image signer (what we just created)

image::tssc-tas/acs-create-policy-4-dnd-image-signer.png[link=self, window="image"]
...
image::tssc-tas/acs-create-policy-5-add-inclusion.png[link=self, window="image"]
...
image::tssc-tas/acs-create-policy-5-inclusion.png[link=self, window="image"]

Click next.

For "Actions", we'll leave it at "Enabled" and "Inform" (for now).

image::tssc-tas/acs-create-policy-6-inform.png[link=self, window="image"]
...
image::tssc-tas/acs-create-policy-7-done.png[link=self, window="image"]
...
image::tssc-tas/acs-violations-unsigned.png[link=self, window="image"]
...
image::tssc-tas/acs-edit-policy.png[link=self, window="image"]

You can click through via "Next, Next, Next,..." or you can directly go to "Actions"

image::tssc-tas/acs-edit-shortcut-actions.png[link=self, window="image"]
...
image::tssc-tas/acs-edit-enforce.png[link=self, window="image"]
...
image::tssc-tas/acs-violations-unsigned-attempted.png[link=self, window="image"]

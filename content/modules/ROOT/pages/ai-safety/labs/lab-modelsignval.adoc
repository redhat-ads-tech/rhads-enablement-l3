...
* *Job (download-model)*: Downloads a sample ONNX model from the ONNX Model.
      ...
      containers:
        - name: download-model
          ...
          command:
            ...
            - -c
            - |
              wget -O /models/model.onnx https://github.com/onnx/models/raw/main/validated/vision/classification/mnist/model/mnist-8.onnx
          volumeMounts:
            - name: model-storage
              mountPath: /models
      restartPolicy: Never

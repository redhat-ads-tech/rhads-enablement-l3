        ...
        - name: download-model
          ...
          command:
            ...
            - |
              ...
              wget -O /models/saved_model.pb https://github.com/varodrig/model-validation-operator/raw/0835d8a8a7297b9f2ee00257c129e934ec724652/demo/signed_model/saved_model.pb
          volumeMounts:
            - name: model-storage
              mountPath: /models
      restartPolicy: Never

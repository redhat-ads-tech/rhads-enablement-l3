...
image::tssc-tpa/vuln-search-log4j.png[]
...
image::tssc-tpa/vuln-search-log4j-affected-sbom.png[]
...
image::tssc-tpa/vuln-search-log4j-affected-sbom-package-view.png[]
...
image::tssc-tpa/sboms-using-package-and-version.png[]
...
image::tssc-tpa/pypa-setuptools.png[]
...
image::tssc-tpa/pypa-setuptools-across-sboms.png[]
...
image::tssc-tpa/generic-search.png[]
...
image::tssc-tpa/generic-search-logback-results.png[]
...
image::tssc-tpa/logback-core-package.png[]

We have a hit, sadly... for *this package in this version*

image::tssc-tpa/model-mesh-logback.png[]
...
image::tssc-tpa/logback-core-package-vulnerabilities.png[]
...
image::tssc-tpa/logback-core-package-vulnerabilities-also-devspaces.png[]

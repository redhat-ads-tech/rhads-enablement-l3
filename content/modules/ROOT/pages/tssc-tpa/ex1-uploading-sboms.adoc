...
image::tssc-tpa/tpa-sboms-view.png[link=self, window="image"]
====
...
image::tssc-tpa/logged-in-as-tpa-manager.png[link=self, window="image"]
...
image::tssc-tpa/tpa-upload-sbom-versions.png[link=self, window="image"]
...
image::tssc-tpa/sbom-edit-label.png[link=self, window="image"]
...
image::tssc-tpa/sbom-label-manual.png[link=self, window="image"]

image::tssc-tpa/sbom-label-manual-assigned.png[link=self, window="image"]
...
image::tssc-tpa/sbom-label-manual-subsequent.png[link=self, window="image"]

It should look similar to this:

image::tssc-tpa/sbom-view-labels.png[link=self, window="image"]
...
image::tssc-tpa/keycloak-cli-client-authentication.png[link=self, window="image"]

image::tssc-tpa/keycloak-cli-client-secret.png[link=self, window="image"]
...
image::tssc-tpa/sbom-view-cli-upload.png[link=self, window="image"]
...
image::tssc-tpa/csaf-vex-upload.png[link=self, window="image"]
...
image::tssc-tpa/advisories.png[link=self, window="image"]

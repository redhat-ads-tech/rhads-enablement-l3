...
image:orchestrator-overview/install-operators.png[link=self, window="image"]
...
+
image::orchestrator-overview/serverless-operators.png[link=self, window="image"]
...
+
image::orchestrator-overview/sonataflow-platform-topology.png[link=self, window="image"]
...
+
image:orchestrator-overview/sonataflow-db-connection.png[link=self, window="image"]

...
+
image::production-rhdh/1.png[Logon,link=self, window="image"]
+
...
+
image::production-rhdh/2.png[{product_rhdh_name} Frontpage,link=self, window="image"]
...
+
image::production-rhdh/3.png[Template start,link=self, window="image"]
+
...
+
image::production-rhdh/4.png[Template parameters,link=self, window="image"]
...
image::production-rhdh/5.png[{product_rhdh_name} Template success,link=self, window="image"]
...
+
image::production-rhdh/6.png[Catalog Components,link=self, window="image"]
...
+
image::production-rhdh/7.png[Component Summary,link=self, window="image"]
+
...
+
image::production-rhdh/8.png[Examining the Pipeline,link=self, window="image"]
...
+
image::production-rhdh/9.png[Examining the Topology plugin,link=self, window="image"]
+
...
+
image::production-rhdh/10.png[Examining the CD plugin,link=self, window="image"]
...
+
image::production-rhdh/11.png[Highlighting the SBOM link,link=self, window="image"]
...
+
image::production-rhdh/12.png[Highlighting the Dev Spaces link,link=self, window="image"]
+
...
+
image::production-rhdh/13.png[Dev Spaces,link=self, window="image"]
...
+
image::production-rhdh/14.png[Highlighting the potential security issue,link=self, window="image"]
...
+
image::production-rhdh/15.png[Examining the potential security issue,link=self, window="image"]
...
+
image::production-rhdh/16.png[Pipeline automatically run as part of a code submit,link=self, window="image"]
+
...
+
image::production-rhdh/17.png[Locating the default pipeline definitions,link=self, window="image"]
...
+
image::production-rhdh/18.png[Showing the new task as part of the executed secure pipeline,link=self, window="image"]
+
...
+
image::production-rhdh/19.png[Gitlab source page,link=self, window="image"]
...
+
image::production-rhdh/20.png[The promotion pipeline in action,link=self, window="image"]
+
...
+
image::production-rhdh/21.png[Promoting to production,link=self, window="image"]
+

...
+
image::third-party-ci/rhdh-jenkins-admin-menu.png[The Jenkins Admin Menu,link=self, window="image"]
. Verify that the listed credentials match those shown.
+
image::third-party-ci/rhdh-jenkins-credentials.png[Credentials Store in Jenkins,link=self, window="image"]
...
+
image::third-party-ci/rhdh-view-template.png[Show template entity details,link=self, window="image"]
...
+
image::third-party-ci/rhdh-jenkins-tpl-repo.png[Jenkins Template GitLab Repository,link=self, window="image"]
+
[NOTE]
====
...
In summary, this `template.yaml` defines a Software Template that collects parameters to scaffold a new Quarkus-based Java application that stores source code in GitLab and stores built container images in Quay. Additionally it has a toggle to enable commit signing, an element of a secure software pipeline.
...
+
image:third-party-ci/rhdh-jenkins-tpl-modified.png[Modified Jenkinsfile.push,link=self, window="image"]
...
+
image:third-party-ci/rhdh-jenkins-params.png[Jenkins Template Parameters,link=self, window="image"]
. Click *Create* and wait for the template to finish processing.
+
image:third-party-ci/rhdh-jenkins-ssc-created.png[Jenkins Template Run,link=self, window="image"]
...
+
image:third-party-ci/rhdh-jenkins-launch-term.png[Launch a Terminal in VSCode,link=self, window="image"]
...
+
image:third-party-ci/rhdh-jenkins-sign-commit.png[Commit Signing Link,link=self, window="image"]
...
+ 
image:third-party-ci/rhdh-jenkins-view-build.png[View Build Icon for Jenkins,link=self, window="image"]
...
+
image:third-party-ci/rhdh-jenkins-blue-ocean.png[Jenkins Blue Ocean View,link=self, window="image"]

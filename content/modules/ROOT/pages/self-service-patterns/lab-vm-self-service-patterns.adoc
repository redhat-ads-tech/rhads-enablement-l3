= Self-service VMs in OpenShift using Software Template Patterns
...
image:self-service-patterns/vm-lab/vm-architecture.png[Red Hat Developer Hub as part of the VM creation process.]

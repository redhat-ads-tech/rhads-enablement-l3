...
image:self-service-patterns/vm-lab/vm-architecture.jpg[Red Hat Developer Hub as part of the VM creation process,link=self, window="image"]
...
image:self-service-patterns/vm-lab/rhdh-create-icon.png[Create UI,link=self, window="image"] 

* Click the *Import an existing Git repository* button.

image:self-service-patterns/vm-lab/rhdh-register-component.png[Create UI,link=self, window="image"] 
...
image:self-service-patterns/vm-lab/rhdh-register-component-finish.png[width=60%,link=self, window="image"] 
...
image:self-service-patterns/vm-lab/vm-catalog.png[width=60%,link=self, window="image"]
...
image:self-service-patterns/vm-lab/vm-sample.png[width=100%,link=self, window="image"]
...
image:self-service-patterns/vm-lab/virt-welcome-page.png[width=100%,link=self, window="image"]
...
image:self-service-patterns/vm-lab/vm-finish-tour.png[width=80%,link=self, window="image"]
...
image:self-service-patterns/vm-lab/virt-volumes-click.png[width=100%,link=self, window="image"]

** Scroll down to explore the available *Instance Types*
** Select *General Purpose* *U series* and *medium* *1 CPUs, 4 GiB memory*

image:self-service-patterns/vm-lab/vm-instancetype-click.png[width=100%,link=self, window="image"]
...
image:self-service-patterns/vm-lab/vm-explore-yaml.png[width=100%,link=self, window="image"]

* From that view, look for the *RHEL10* related values:

image:self-service-patterns/vm-lab/vm-yaml-updates.png[width=100%,link=self, window="image"]
...
image:self-service-patterns/vm-lab/self-service-catalog.png[width=40%,link=self, window="image"]
...
image:self-service-patterns/vm-lab/template-unregister.png[width=60%,link=self, window="image"]

** Confirm the action.

image:self-service-patterns/vm-lab/confirm-unregister.png[width=60%,link=self, window="image"]
...
image:self-service-patterns/vm-lab/gitlab-edit-file.png[width=90%,link=self, window="image"]
...
image:self-service-patterns/vm-lab/gitlab-edit-file-updated.png[width=90%,link=self, window="image"]
...
image:self-service-patterns/vm-lab/vm-valuesfile-changes.png[width=90%,link=self, window="image"]
...
image:self-service-patterns/vm-lab/vm-template-changes1.png[width=90%,link=self, window="image"]

* Add a new required parameter under the comment `# UPDATE: Add other required parameters here` called `rhel_version`:

image:self-service-patterns/vm-lab/vm-template-changes1.1.png[width=90%,link=self, window="image"]
...
image:self-service-patterns/vm-lab/vm-template-changes2.png[width=90%,link=self, window="image"]
...
image:self-service-patterns/vm-lab/vm-template-step1.png[width=90%,link=self, window="image"]
...
image:self-service-patterns/vm-lab/vm-template-step2.png[width=90%,link=self, window="image"]
...
image:self-service-patterns/vm-lab/vm-catalog-new.png[width=80%,link=self, window="image"]

* You should see a screen like this one:


image:self-service-patterns/vm-lab/vm-rhel-updated.png[width=100%,link=self, window="image"]
...
image:self-service-patterns/vm-lab/vm-created.png[width=100%,link=self, window="image"]
...
image:self-service-patterns/vm-lab/vm-created2.png[width=100%,link=self, window="image"]
...
* https://www.redhat.com/en/technologies/cloud-computing/openshift/virtualization[Red Hat OpenShift Virtualization^]

* https://developers.redhat.com/articles/2024/08/09/building-virtual-machines-red-hat-developer-hub-what-why-and-how#[Building virtual machines with Red Hat Developer Hub: The what, why, and how^]

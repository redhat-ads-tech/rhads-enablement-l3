...
https://github.com/redhat-ads-tech/rhads-enablement-l3/blob/main/content/modules/ROOT/solutions/self-service-patterns/project-lab/quota.yaml[quota.yaml solution file^]
...
image:self-service-patterns/namespace-lab/catalog-open.png[width=100%]

* Now, a new component has being created and you should a screen similar like this:


image:self-service-patterns/namespace-lab/namespace-created.png[width=100%]

...
image:self-service-patterns/namespace-lab/rhdh-create-icon.png[Create UI,link=self, window="image"] 

* Click the *Import an existing Git repository* button.

image:self-service-patterns/namespace-lab/rhdh-register-component.png[Create UI,link=self, window="image"] 
...
image:self-service-patterns/namespace-lab/rhdh-register-component-finish.png[width=90%,link=self, window="image"] 
...
image:self-service-patterns/namespace-lab/project-template.png[width=40%,link=self, window="image"]
...
image::self-service-patterns/namespace-lab/project-sample.png[link=self, window="image"]
...
image:self-service-patterns/namespace-lab/self-service-catalog.png[width=50%,link=self, window="image"]

* Select the **OpenShift Project Medium Size**

* Access the Source code by clicking on *View Source*

image:self-service-patterns/namespace-lab/namespace-edit-catalog.png[width=50%,link=self, window="image"]
...
image:self-service-patterns/namespace-lab/quota-file-edit.png[width=90%,link=self, window="image"]
...
image:self-service-patterns/namespace-lab/project-file-changes.png[width=90%,link=self, window="image"]
...
image:self-service-patterns/namespace-lab/rhdh-refresh-catalog.png[width=90%,link=self, window="image"]
...
image:self-service-patterns/namespace-lab/project-template.png[width=50%,link=self, window="image"]
...
image:self-service-patterns/namespace-lab/namespace-updated.png[link=self, window="image"]

* Open the catalog from the component's creation page by clicking on the *Open Component in Catalog* button.

image:self-service-patterns/namespace-lab/catalog-open.png[width=90%,link=self, window="image"]

* A new component has been created and you should see a screen similar to this:

image:self-service-patterns/namespace-lab/namespace-created.png[width=90%,link=self, window="image"]
...
image:self-service-patterns/namespace-lab/ns-list.png[width=90%,link=self, window="image"]
...
image:self-service-patterns/namespace-lab/rq1.png[width=90%,link=self, window="image"]

* Scroll to the bottom to view the details of the quota and confirm your new limits are in place:

image:self-service-patterns/namespace-lab/rq2.png[width=90%,link=self, window="image"]

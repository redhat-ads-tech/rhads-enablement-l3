...
In this section, you will replace the *whole content* of the devfile.yaml file. The new application requires new libraries that will be used during runtime, given that this is a web python AI application the devfile.yaml it needs to be replaced.

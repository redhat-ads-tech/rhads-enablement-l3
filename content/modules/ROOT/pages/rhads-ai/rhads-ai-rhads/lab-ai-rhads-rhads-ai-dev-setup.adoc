...
Usually, Platform Engineers, will update the software templates or components to manage custom configurations. In this case, you will apply these configurations directly to the newly created component since we are leveraging pre-existent templates. Let's work on these requests!

...
Learn more about these templates at https://docs.redhat.com/en/documentation/red_hat_advanced_developer_suite$$_-$$_software_supply_chain/1.7/html/customizing_red_hat_advanced_developer_suite$$_-$$_software_supply_chain/customizing-sample-pipelines_default[Customizing Sample Pipelines^].

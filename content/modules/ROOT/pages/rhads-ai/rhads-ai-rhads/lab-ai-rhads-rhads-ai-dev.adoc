...
* Login as a Developer to explore the Developer experience. 
** Logout from Red Hat Developer Hub by clicking on the user and click on *Sign out*

image:rhads-ai/rhads/rhdh-logout.png[width=100%]
...
* You should see a screen similar like this:
...
== Let's add the solution to the new project:
Follow the next steps:

=== Update index.html

* On Red Hat Red Hat OpenShift Dev Spaces:

- Create a new folder name: *templates*
image:rhads-ai/rhads/devspaces-newfolder.png[width=100%]

- Add a new file with the name *index.html* 
image:rhads-ai/rhads/devspaces-newfile.png[width=100%]

- On the index.html:
image:rhads-ai/rhads/devspaces-index.html.png[width=100%]
...
https://github.com/redhat-ads-tech/rhads-enablement-l3/blob/main/content/modules/ROOT/solutions/rhads-ai/rhads-ai-rhads-app/index.html[index.html solution file^] 


=== Update app.py
* Go to the app.py file:

image:rhads-ai/rhads/devspaces-app.png[width=20%]
...
* On Red Hat Red Hat OpenShift Dev Spaces, click on the app.py file 

image:rhads-ai/rhads/devspaces-app.py.png[width=100%]
* Paste the content on the app.py file replacing the whole content.


* Verify the solution

https://github.com/redhat-ads-tech/rhads-enablement-l3/blob/main/content/modules/ROOT/solutions/rhads-ai/rhads-ai-rhads-app/app.py[app.py solution file^] 


=== Add a new python file: search_agent.py 
...
* Paste the following name. Hit *enter*
...
https://github.com/redhat-ads-tech/rhads-enablement-l3/blob/main/content/modules/ROOT/solutions/rhads-ai/rhads-ai-rhads-app/search_agent.py[search_agent.py solution file^] 
...
https://github.com/redhat-ads-tech/rhads-enablement-l3/blob/main/content/modules/ROOT/solutions/rhads-ai/rhads-ai-rhads-app/Dockerfile[Dockerfile solution file^] 
...
https://github.com/redhat-ads-tech/rhads-enablement-l3/blob/main/content/modules/ROOT/solutions/rhads-ai/rhads-ai-rhads-app/requirements.txt[requirements.txt solution file^] 

*Note:* Depending on the organization, Platform Engineering teams might be responsible for defining the Dockerfile.


Before submitting your changes,let's create additional resources in Kubernetes.
...
kubectl create secret generic ai-agent-secrets \
  --from-literal=LLM_API_BASE_URL=REPLACE_1/v1 \
  --from-literal=LLM_API_KEY=REPLACE_2 \
  --from-literal=TAVILY_API_KEY=REPLACE_3 \
  --from-literal=MODEL_NAME=Llama-3.2-3B \
  -n tssc-app-development
----
You will find the values to be replacing the placeholders in the next section. Do not hit enter yet.
...
** Copy the *Endpoint URL* and paste it into the *REPLACE_1* in the kubernetes secret

** Copy the *API Key* and paste it into the *REPLACE_2* in the kubernetes secret
...
* Paste your key into the *REPLACE_3* in the kubernetes secret.

* Hit enter to create the secret, you should see a message: *"secret created"*
...
image:rhads-ai/rhads/devspaces-sourceicon.png[width=30%]
...
== Congratulations on building an Agent 

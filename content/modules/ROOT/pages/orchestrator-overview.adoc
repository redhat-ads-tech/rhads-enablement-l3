...
====
+
image:orchestrator-overview/orchestrator-plugin.png[Orchestrator and Notification dynamic plugins, width=60%]
+
...
+
image:orchestrator-overview/orchestrator-plugin-configuration.png[Orchestrator configuration, width=60%]
+
...
+
image:orchestrator-overview/orchestrator-notification-menu.png[Orchestrator and Notification in RHDH, width=60%]
. Select *Orchestrator* from the left-hand side menu.
+
image:orchestrator-overview/workflow-orchestrator-overview.png[Workflow Orchestrator overview]
+
...
+
image:orchestrator-overview/notifications-overview.png[Notifications overview]
+
...
. Select the image:orchestrator-overview/plus-icon.png[width=15px] icon on the top navigation bar to access the *Self-service* menu.
+
image:orchestrator-overview/create-icon.png[] 
...
. Select the image:orchestrator-overview/plus-icon.png[width=15px] icon on the top navigation bar to see the new templates.
+
...
. Select the image:orchestrator-overview/plus-icon.png[width=15px] icon on the top navigation bar.
...
+
image:orchestrator-overview/rhdh-developer-self-service-templates-dev.png[Developer Self Service Software Templates]
...
image:orchestrator-overview/template-large-namespace-annotation.png[Template Namespace Large Annotation]
...
+
image:orchestrator-overview/gitlab-copy-file-contents.png[GitLab Copy File Contents]
...
+
image:orchestrator-overview/openshift-console-import.png[OpenShift Console Import]
. Paste the ArgoCD manifest in the editor. Click the *Create* button.
+
image:orchestrator-overview/openshift-console-import-create.png[OpenShift Console Import Create]
...
+
image:orchestrator-overview/openshift-console-orchestrator-namespace.png[OpenShift Pods in orchestrator namespace]
...
+
image:orchestrator-overview/orchestrator-workflow-run.png[]
...
+
image:orchestrator-overview/notification-1.png[]
...
+
image:orchestrator-overview/component-namespace-1.png[]
...
+
image:orchestrator-overview/orchestrator-workflow-run-3.png[]
...
+
image:orchestrator-overview/gitlab-issue-5.png[]

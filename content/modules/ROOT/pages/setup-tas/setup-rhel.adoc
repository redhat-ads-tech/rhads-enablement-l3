...
+
image::setup-tas/rhel-workshop-catalog.png[width=80%,link=self, window="image"]
...
+
image::setup-tas/rhel-workshop-form.png[width=80%,link=self, window="image"]
+
[NOTE]
====
...
+
image::setup-tas/rhel-workshop-provisioning.png[width=80%,link=self, window="image"]
...
+
image::setup-tas/rhel-workshop-service.png[width=80%,link=self, window="image"]
+
...
+
image::setup-tas/rhel-workshop-showroom.png[width=80%,link=self, window="image"]
+   
* Follow the step-by-step instructions provided in the workshop
+
image::setup-tas/rhel-workshop-instructions.png[width=80%,link=self, window="image"]

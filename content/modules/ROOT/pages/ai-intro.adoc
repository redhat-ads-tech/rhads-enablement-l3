...
image::ai-intro/personas_ai.png[Personas,link=self, window="image"]
...
image::ai-intro/rag_how_works.png[RAG flow,link=self, window="image"]
...
image::ai-intro/mcp_architecture.png[MCP architecture,link=self, window="image"]
...
image::ai-intro/llama_stack.png[Llama Stack,link=self, window="image"]
